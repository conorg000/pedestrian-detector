...
def create_tf_example(example, path, data_list):
  ...
  filename = example + '.jpg' # Filename of the image. Empty if image is not from file
  ...
  classes_text = ['Pedestrian'] * (len(coordinates)) # List of string class name of bounding box (1 per box)
